...
import com.example.bankchellengemobileapp.data.pixKey.dto.PixTransferResponseDTO
...
interface PixKeyApiService {
    ...
    @GET("/api/v1/pix/{accountId}/keys")
    suspend fun findAll(@Path("accountId") accountId: UUID): Response<List<PixTransferResponseDTO>>
    ...
    @DELETE("/api/v1/pix/{accountId}/delete")
